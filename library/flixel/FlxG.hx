...
class FlxG
{
	...
	/**
	 * Makes more easier to change FPS and fixes the slowdown issues
	 */
	public static var gameFramerate(default, set):Int;
	...
	static function set_gameFramerate(value:Int):Int
	{
		updateFramerate = value;
		drawFramerate = value;
	...
	static function get_gameFramerate():Int
	{
		var value = drawFramerate;
		return value;
	}
