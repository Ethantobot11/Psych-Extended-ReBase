...
class CreditsState extends MusicBeatState
{
	...
	var mainCredits:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		...
		['PolybiusProxy',		'proxy',			'.MP4 Video Loader Library (hxvlc)',					'https://twitter.com/polybiusproxy',	'DCD294'],
	...
	override function create()
	{
		...
		else #end path = #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modsList.txt';
