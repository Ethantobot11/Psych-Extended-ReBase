...
class WeekData {
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false)
	{
		...
		var modsListPath:String = #if mobile StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modsList.txt';
		#if MODPACK_ALLOWED
		if (ClientPrefs.data.currentModPack != null) modsListPath = Paths.modpack(ClientPrefs.data.currentModPack + '/modsList.txt');
		else #end modsListPath = #if mobile StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modsList.txt';
