...
class Paths
{
	...
	inline static public function mods(key:String = '') {
		#if MODPACK_ALLOWED
		var modpack = #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modpack/' + ClientPrefs.data.currentModPack + '/' + key;
		if (ClientPrefs.data.currentModPack != null && FileSystem.exists(modpack))
			return modpack;
		//global
		if (ClientPrefs.data.currentModPack != null) return #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modpack/' + key;
		else #end return #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'mods/' + key;
	}
	...
	inline public static function getScriptPath(file:String = '')
	{
		...
		if(FileSystem.exists(#if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'scripting/$file')) {
			//trace('file: ' + #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end file + ' exists');
			return #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'scripting/$file';
		}
		else
		#end
	...
	inline static public function modpack(key:String = '') {
		#if MODPACK_ALLOWED
		return #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modpack/' + key;
		#else
